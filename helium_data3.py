...
if page == 'Earnings Data':
    if city_name == 'ALL':
        ...
        st.table(cities.style.apply(lambda x: ['background: lightsteelblue' if x.name == 'TOTAL' else '' for i in x], axis=1).set_precision(2))#.highlight_max(axis = 0))
